...
This script configures database roles for the managed identity.
"""
import pyodbc
import struct
from azure.identity import AzureCliCredential

# Database connection settings - Update these with your values from deployment
SERVER = "sql-expensemgmt-UNIQUESUFFIX.database.windows.net"
DATABASE = "Northwind"
SQL_SCRIPT_FILE = "scripts/script.sql"
